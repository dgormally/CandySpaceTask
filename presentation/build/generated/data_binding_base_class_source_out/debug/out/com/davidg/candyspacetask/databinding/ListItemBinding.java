...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView heroName) {
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.heroName;
      TextView heroName = rootView.findViewById(id);
      if (heroName == null) {
        break missingId;
      }

      return new ListItemBinding((LinearLayout) rootView, heroName);
    }
